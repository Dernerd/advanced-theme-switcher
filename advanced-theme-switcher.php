...
Description: Advanced Theme Switcher ermöglicht BuddyPress- und Multisite-Benutzern die Möglichkeit, zwischen verschiedenen Themen zu wechseln, oder Ihnen die Möglichkeit, verschiedene Themendesigns auf einer BuddyPress oder Multisite zu profilieren.
Version: 1.1.0
Author: WMS N@W
...
$MyUpdateChecker = PucFactory::buildUpdateChecker(
	'https://n3rds.work//wp-update-server/?action=get_metadata&slug=advanced-theme-switcher', 
	__FILE__, 
	...
	class Advanced_Theme_Switcher {
		...
		var $queried_theme = '';
			...
			function ats_admin_menu() {
				add_options_page( 'Theme Switcher', 'Theme Switcher', 'manage_options', 'ats-admin-menu', 'admin_menu_callback' );
			}
			add_action( 'admin_menu', 'ats_admin_menu' );

			function admin_menu_callback() {
				include plugin_dir_path( __FILE__ ) . 'admin/ats-admin-menu.php';
			}
...
if ( !class_exists('Advanced_Theme_Switcher_Widget') ) {
	class Advanced_Theme_Switcher_Widget extends WP_Widget {
		...
		function __construct() {
	 		...
	 		/* Create the widget. */
			 parent::__construct(
                'advanced-theme-switcher-widget',
                __('Advanced Theme Switcher Widget', 'advanced-theme-switcher'),
                $widget_ops,
                $control_ops
            );
		}
